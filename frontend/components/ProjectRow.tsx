...
export default function ProjectRow({project}: {project: Project}) {
    ...
    return (
        <tr className="hover:bg-slate-100 transition border-t">
            ...
            <td className="p-4">
                <a className="hover:underline text-blue-500 hover:text-blue-800 whitespace-nowrap" href={ "/projects/settings/" + project.name }><strong>{ project.name }</strong></a>
            </td>
            ...
            <td className="p-4">
                <a href={"http://" + getURL()} className="text-blue-500 hover:text-blue-800 transition float-right flex flex-nowrap">
